...
- **diamond**: calculations with a primitive cell
...
- **diamond1**: calculations with a cubic cell
- **nvc\<i\>**: calculations with a NV-center in an i^3 supercell
